...
import drabat.elementrix.screen.PantallaSound;
public class World {
	...
	public void Llenar()
	{
		/*LLENA LA MATRIZ DE ELEMENTOS CON VALORES ALEATORIOS*/
	...
	public void Destruccion0(int x,int y)
	{
		...
		/*MIENTRAS I SEA MENOR AL TAMAÑO DEL VECTOR
	...
	{
		int x,y,i=0;
		/*SI EL TAMAÑO DEL VECTOR ES MAYOR O IGUAL A 3 ENTONCES 
		 * REALIZA LA DESTRUCCION SI NO ES ASI LA OMITE*/
		if(vector.size()>=3)
		{
			/*MIENTRAS EL INDICADOR SEA MENOR AL TAMAÑO 
